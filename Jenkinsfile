...
pipeline {
    ...
    agent {
        docker {
            ...
            args '-v /home/jenkins/.ssh:/home/jenkins/.ssh -v /var/run/docker.sock:/var/run/docker.sock -v $HOME/.m2:/var/maven/.m2:z -e MAVEN_CONFIG=/var/maven/.m2 -e MAVEN_OPTS=-Duser.home=/var/maven --publish 2200:22 -e JENKINS_AGENT_SSH_PUBKEY=ssh-rsa  jyauyo@outlook.com.pe jenkins/ssh-agent'
        }
    }
